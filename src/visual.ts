...
export class Visual implements IVisual {
  ...
  private static parseSettings(
    ...
    if (
      ...
      DataViewHelper.migrateObjectProperties(
        dataView,
        host,
  ...
  public enumerateObjectInstances(
    ...
    let instances: VisualObjectInstance[] = (VisualSettings.enumerateObjectInstances(
    ...
    switch (objectName) {
      case "yAxis": {
        ...
        if (
          ...
          !this.viewModelHandler.viewModel.yAxis.numberFormat.displayUnit
        ) {
          instances[0].properties["titleStyle"] = "title";
          instances[0].validValues.titleStyle = ["title"];
        }
      ...
      case "layout": {
        ...
        instances[0].validValues.multipleHeight = instances[0].validValues.multipleWidth = {
          numberRange: {
